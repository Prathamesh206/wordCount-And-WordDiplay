...
public class OperationMethod {
	...
	public HashMap<String, String> getWordDisplay(String operation){
		...
		case "2":                                                        //for multiFile
			HashMap<String, ArrayList<String>> files=displayWord.wordsDisplay(multipleFileReadr.multiFileRead(FileInput.getMultipleFileInput()));
			for(Map.Entry<String, ArrayList<String>> file:files.entrySet()) {
